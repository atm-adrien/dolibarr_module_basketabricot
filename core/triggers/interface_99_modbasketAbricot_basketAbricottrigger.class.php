...
/**
 * 	\file		core/triggers/interface_99_modMyodule_basketAbricottrigger.class.php
 * 	\ingroup	basketabricot
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modBasketabricot_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfacebasketAbricottrigger
{
